      ...
      <div className="container">
        <div id="introsection" className="row">
          <div className="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3 col-sm">
            ...
            <p>Please do drop me a line on GitHub to get in touch. I am still learning so any feedback on this site is very welcome.</p>
          </div>
        </div>
