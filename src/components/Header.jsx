  ...
  render() {
    return (
      <header className="row sticky">
        <Link to='/' id='homelink' className='logo'>HPC</Link>
        ...
        <a href='https://github.com/HundredPercentCoverage' id='githublink' className='button col-sm col-md'>
          <GitHub size={ICON_SIZE} style={{verticalAlign: "sub"}}/>
          <span className="headerlinktext"> GITHUB</span>
        </a>
        <a href='https://twitter.com/' id='twitterlink' className='button col-sm col-md'>
